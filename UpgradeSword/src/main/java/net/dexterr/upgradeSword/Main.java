package net.dexterr.upgradeSword;
...
public final class Main extends JavaPlugin {
    ...
    private void setupCommands() {
        try {
            ImmutableSet<ClassPath.ClassInfo> infoList = ClassPath.from(getClassLoader())
                    .getTopLevelClassesRecursive("net.dexterr.upgradeSword.commands");
    ...
    private void setupListeners() {
        try {
            ImmutableSet<ClassPath.ClassInfo> infoList = ClassPath.from(getClassLoader())
                    .getTopLevelClassesRecursive("net.dexterr.upgradeSword.listeners");
            for (ClassPath.ClassInfo info : infoList) {
                Class<?> cls = Class.forName(info.getName());
