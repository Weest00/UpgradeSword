...
import net.dexter.UpgradeSword.apis.NumberUtils;
...
public class SwordInventory {
    ...
    public void openInventory(Player player) {
        ...
        ItemStack head = new ItemBuilder(Material.PLAYER_HEAD)
                ...
                .setLore("§7Your balance: §2$§f" + NumberUtils.format(VaultHook.getEconomy().getBalance(player)))
        ...
        ItemStack info = new ItemBuilder(Material.GOLD_INGOT)
                ...
                .setLore("§7Increase your sword's loot!", "", "§fCurrent level: §a" + item.getEnchantmentLevel(Enchantment.LOOTING), "§fMax level: §b" + maxLevelToString(player, Enchantment.LOOTING), "", "§f Price: §2$§7" + NumberUtils.format(totalPrice(player, Enchantment.LOOTING, Config.getLootingPrice(), Config.getLootingMultiplicator())),
        ...
        ItemStack rename = new ItemBuilder(Material.NAME_TAG)
                ...
                .setLore("", "§fPrice: §2$§7" + NumberUtils.format(Config.getRenameSwordPrice()), "", "§7Click right here to rename your sword.")
                .hideAllFlags()
                .build();
    ...
    private boolean isEnchantmentTooHigh(Player player, Enchantment enchantment) {
        ...
        int maxLevel;
        if (Config.getUseDefaultLevel()) {
            maxLevel = enchantment.getMaxLevel();
        } else {
            maxLevel = Config.getCustomMaxLevels().getOrDefault(enchantment, enchantment.getMaxLevel());
        }
    ...
    private String maxLevelToString(Player player, Enchantment enchantment) {
        int maxLevel;
    ...
    private String nextLeveltoString(Player player, String enchantmentName, Enchantment enchantment) {
        ItemStack itemHand = player.getInventory().getItemInMainHand();
        int currentLevel = itemHand.getEnchantmentLevel(enchantment);
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (slot == 19) {
            if (isEnchantmentTooHigh(player, Enchantment.LOOTING)) {
        ...
        if (slot == 20) {
            if (isEnchantmentTooHigh(player, Enchantment.UNBREAKING)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 21) {
            if (isEnchantmentTooHigh(player, Enchantment.FIRE_ASPECT)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 22) {
            if (isEnchantmentTooHigh(player, Enchantment.SHARPNESS)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 23) {
            if (isEnchantmentTooHigh(player, Enchantment.KNOCKBACK)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 24) {
            if (isEnchantmentTooHigh(player, Enchantment.VANISHING_CURSE)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 25) {
            ...
            if (isEnchantmentTooHigh(player, Enchantment.MENDING)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
        ...
        if (slot == 31) {
            if (isEnchantmentTooHigh(player, Enchantment.SWEEPING_EDGE)) {
                player.closeInventory();
                player.playSound(player.getLocation(), Sound.ENTITY_VILLAGER_NO, 1F, 1F);
